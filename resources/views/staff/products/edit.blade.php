                    ...
                    <form action="{{ route('staff.products.update', $product->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price', $product->price) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
